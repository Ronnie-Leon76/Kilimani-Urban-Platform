              ...
              <CardContent className="p-6">
                <div className="space-y-4">
                  {recentReports.map((report, index) => (
                    <div 
                      key={report.id} 
                      className="group bg-gradient-to-r from-white to-gray-50/50 rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] animate-in slide-in-from-bottom duration-500 border border-gray-100/50"
                      style={{ animationDelay: `${index * 100}ms` }}
                    >
                ...
                <div className="space-y-8">
                  ...
                  <div>
                    ...
                    <div className="space-y-6">
                      <div className="group bg-gradient-to-r from-orange-50 to-red-50 rounded-2xl p-6 border border-orange-200 hover:shadow-xl transition-all duration-500 hover:scale-[1.02]">
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            <div className="flex items-center gap-3 mb-3">
                              ...
                              <div>
                                <h5 className="font-bold text-gray-900">Kilimani Road Expansion</h5>
                                <p className="text-sm text-gray-600">Community consultation on proposed road widening</p>
                              </div>
                            </div>
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
                              <div className="flex items-center gap-2 text-sm">
                                <Calendar className="w-4 h-4 text-green-600" />
                                <span className="text-green-600 font-medium">Ends Jan 30, 2024</span>
                              </div>
                              <div className="flex items-center gap-2 text-sm">
                                <Users className="w-4 h-4 text-blue-600" />
                                <span className="text-blue-600 font-medium">234 participants</span>
                              </div>
                              <div className="flex items-center gap-2 text-sm">
                                <MessageSquare className="w-4 h-4 text-purple-600" />
                                <span className="text-purple-600 font-medium">67 comments</span>
                              </div>
                            </div>
                      ...
                      <div className="group bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-200 hover:shadow-xl transition-all duration-500 hover:scale-[1.02]">
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            <div className="flex items-center gap-3 mb-3">
                              ...
                              <div>
                                <h5 className="font-bold text-gray-900">Community Park Development</h5>
                                <p className="text-sm text-gray-600">Planning for new community park near Yaya Centre</p>
                              </div>
                            </div>
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                              <div className="flex items-center gap-2 text-sm">
                                <Calendar className="w-4 h-4 text-green-600" />
                                <span className="text-green-600 font-medium">Ends Feb 15, 2024</span>
                              </div>
                              <div className="flex items-center gap-2 text-sm">
                                <Users className="w-4 h-4 text-blue-600" />
                                <span className="text-blue-600 font-medium">189 participants</span>
                              </div>
                              <div className="flex items-center gap-2 text-sm">
                                <MessageSquare className="w-4 h-4 text-purple-600" />
                                <span className="text-purple-600 font-medium">43 comments</span>
                              </div>
                            </div>
                          </div>
                          <Button size="sm" className="bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 text-white shadow-lg ml-4">
                            <Settings className="w-4 h-4 mr-1" />
                            Manage
                          </Button>
                        </div>
                  ...
                  <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-2xl p-8 border border-indigo-200">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                      <div className="text-center bg-white rounded-xl p-4 shadow-lg border border-indigo-100">
                      ...
                      <div className="text-center bg-white rounded-xl p-4 shadow-lg border border-green-100">
                      ...
                      <div className="text-center bg-white rounded-xl p-4 shadow-lg border border-orange-100">
                        <div className="text-3xl font-bold text-orange-600 mb-1">1,245</div>
                        <div className="text-sm text-gray-600 font-medium">Total Participants</div>
                      </div>
                      <div className="text-center bg-white rounded-xl p-4 shadow-lg border border-purple-100">
